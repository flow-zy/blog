...
可以用任何文本编辑器来编写 JavaScript 代码。这里推荐 [Visual Studio Code]
...
运行 JavaScript 也可以在本地架设一个 Web 服务器，然后以 `http://` 或 `https://` 开头的地址来正常执行所有 JavaScript 代码。如有需要请下载 flow 制作的 WAMP / WNMP 一键安装工具。
...
关于 Node.js 的详细教程，请查看[这里](../../node/README.md)
